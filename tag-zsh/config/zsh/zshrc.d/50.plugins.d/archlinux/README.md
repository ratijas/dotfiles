...
| auorph (aurph?) | sudo aura -Oj                           | Remove orphans using aura                                               |
...
| auupd (aupg?)   | sudo aura -Sy && sudo abs && sudo aur   | Update and refresh local package, ABS and AUR databases                 |
| auupd (aupg?)   | sudo aura -Sy && sudo abs               | Update and refresh the local package and ABS databases                  |
| auupd (aupg?)   | sudo aura -Sy && sudo aur               | Update and refresh the local package and AUR databases                  |
| auupd (aupg?)   | sudo aura -Sy                           | Update and refresh the local package database                           |
